...
\begin{frame}[fragile]{Available Themes}
    ...
    {\footnotesize \begin{itemize}
        ...
        \item Informatik-Psycho: \testcolor{ur-Informatik-Psycho}, \testcolor{urBlock-Informatik-Psycho-title}, \testcolor{urBlock-Informatik-Psycho-main}
        \item Theologie: \testcolor{ur-Theologie}, \testcolor{urBlock-Theologie-title}, \testcolor{urBlock-Theologie-main}
        \item Wirtschafts: \testcolor{ur-Wirtschafts}, \testcolor{urBlock-Wirtschafts-title}, \testcolor{urBlock-Wirtschafts-main}
        \item Medizin: \testcolor{ur-Medizin}, \testcolor{urBlock-Medizin-title}, \testcolor{urBlock-Medizin-main}
